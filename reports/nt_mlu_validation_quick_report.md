...
| --- | --- | --- | --- | --- | --- |
| vllm_native | 128 | 22280.29 | 11499.50 | 0.7124 | native |
| nt_all_on | 128 | 865.49 | 446.71 | 18.3387 | RMSNorm, SiluAndMul, MatMul, Embedding, LMHead, PagedAttentionPrefill, PagedAttentionDecode, RoPE, TopKTopP, RandomSample |
| nt_disable_fa | 128 | 864.92 | 446.41 | 18.3508 | RMSNorm, SiluAndMul, MatMul, Embedding, LMHead, RoPE, TopKTopP, RandomSample |
| nt_disable_fa_mm | 128 | 1055.57 | 544.81 | 15.0365 | RMSNorm, SiluAndMul, Embedding, RoPE, TopKTopP, RandomSample |
...
| mode | batch | total tok/s | output tok/s | mean sec/iter | hit_ops |
| --- | --- | --- | --- | --- | --- |
| vllm_native | 256 | 46681.50 | 24093.68 | 0.6800 | native |
| nt_all_on | 256 | 9329.03 | 4814.98 | 3.4027 | GELU, LayerNorm, MatMul, Embedding, WPE, NTWPEKernel, LMHead, PagedAttentionPrefill, PagedAttentionDecode, TopKTopP, RandomSample |
| nt_disable_fa | 256 | 9337.66 | 4819.44 | 3.3996 | GELU, LayerNorm, MatMul, Embedding, WPE, NTWPEKernel, LMHead, TopKTopP, RandomSample |
| nt_disable_fa_mm | 256 | 45012.21 | 23232.11 | 0.7052 | GELU, LayerNorm, Embedding, WPE, NTWPEKernel, TopKTopP, RandomSample |
