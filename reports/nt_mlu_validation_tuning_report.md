...
| --- | --- | --- | --- | --- | --- |
| vllm_native | 128 | 22251.12 | 11484.45 | 0.7133 | native |
| nt_all_on | 128 | 913.44 | 471.45 | 17.3760 | RMSNorm, SiluAndMul, MatMul, Embedding, LMHead, PagedAttentionPrefill, PagedAttentionDecode, RoPE, TopKTopP, RandomSample |
| nt_disable_fa | 128 | 913.32 | 471.39 | 17.3783 | RMSNorm, SiluAndMul, MatMul, Embedding, LMHead, RoPE, TopKTopP, RandomSample |
| nt_disable_fa_mm | 128 | 1134.32 | 585.45 | 13.9926 | RMSNorm, SiluAndMul, Embedding, RoPE, TopKTopP, RandomSample |
...
| mode | batch | total tok/s | output tok/s | mean sec/iter | hit_ops |
| --- | --- | --- | --- | --- | --- |
| vllm_native | 256 | 46469.11 | 23984.05 | 0.6831 | native |
| nt_all_on | 256 | 9333.07 | 4817.07 | 3.4012 | GELU, LayerNorm, MatMul, Embedding, WPE, NTWPEKernel, LMHead, PagedAttentionPrefill, PagedAttentionDecode, TopKTopP, RandomSample |
| nt_disable_fa | 256 | 9329.79 | 4815.38 | 3.4024 | GELU, LayerNorm, MatMul, Embedding, WPE, NTWPEKernel, LMHead, TopKTopP, RandomSample |
| nt_disable_fa_mm | 256 | 46151.35 | 23820.05 | 0.6878 | GELU, LayerNorm, Embedding, WPE, NTWPEKernel, TopKTopP, RandomSample |
